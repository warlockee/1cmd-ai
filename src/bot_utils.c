/*
 * bot_utils.c - General utility functions for onecmd
 *
 * Contains strmatch() (glob-style pattern matching) and
 * xmalloc()/xrealloc()/xfree() (OOM-aborting allocator wrappers).
 */
...
/* ============================================================================
 * Allocator wrappers: exit on OOM instead of trying to recover.
 * ========================================================================= */
