...
Calling spec:
  ...
  Side effects: copies default SOP on first run, reads files

Files:
  onecmd/manager/default_sop.md  (bundled)
  .onecmd/agent_sop.md           (user-editable copy)
  .onecmd/custom_rules.md        (user-defined additions)
"""
